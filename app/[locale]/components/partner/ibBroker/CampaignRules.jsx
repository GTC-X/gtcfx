  ...
  const rules = [
    {
      ...
      content: [
        "This campaign is only applicable for currency trading, gold, silver, and oil markets.",
    ...
    <div className="py-5">
      {rules.map((rule, index) => (
        <div key={index} className="mb-4">
          <button
            className="w-full text-left px-4 py-5 bg-transparent bg-gradient-to-r from-[#243586] from-10% via-[#222e73] via-30% to-[#141b43] to-90% border border-gray-50 hover:bg-secondary focus:outline-none font-bold text-secondary hover:text-white"
          ...
          >
            <ul className="list-disc text-white pl-5 text-left">

    ...
    <LocationContextProvider>
      <section className="relative hero-banner py-10 md:py-14 lg:py-16 2xl:py-20 bg-gradient-to-t from-[#24358b] via-[#202766] to-[#141b43] border-y border-gray-200">
        ...
        <div className="relative z-10 container flex flex-col md:flex-row justify-between items-center h-full">
          <div className="order-2 md:order-2 content-side text-center ltr:md:text-left rtl:md:text-right basis-full md:basis-9/12">
            ...
            <div className="flex flex-col gap-2 text-base md:text-xl pt-2 text-gray-200">
              <p>{t("validUntil")}</p>
       
              <p className="text-sm cursor-pointer mb-5"
                onClick={(e) => {
                  e.preventDefault();
          ...
          <div className="order-2 md:order-2 iframe-code w-full basis-full md:basis-3/12">
          <VPSPakFrom />
          </div>
        </div>
